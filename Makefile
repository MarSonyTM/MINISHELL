...
#    Updated: 2024/03/28 12:35:44 by mafurnic         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE_FILES := main.c lexer/lexer.c lexer/lexer_utils.c lexer/determine_token_type.c lexer/determine_token_type1.c lexer/process1.c lexer/process2.c \
				...
				parser/initialize_new_command.c  env/arr_to_linked_list.c execution/executor_utils2.c /signals/signals.c expansion/expansion.c env/ft_getenv.c \

...
#    Updated: 2024/03/25 12:34:01 by mafurnic         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE_FILES := main.c lexer/lexer.c lexer/lexer_utils.c lexer/determine_token_type.c lexer/determine_token_type1.c  parser/parser.c custom/custom_functions1.c custom/custom_functions2.c custom/custom.c \

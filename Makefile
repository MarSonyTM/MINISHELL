...
#    Updated: 2024/03/25 13:59:48 by mafurnic         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE_FILES := main.c lexer/lexer.c lexer/lexer_utils.c lexer/determine_token_type.c lexer/determine_token_type1.c lexer/process1.c  parser/parser.c custom/custom_functions1.c custom/custom_functions2.c custom/custom.c \

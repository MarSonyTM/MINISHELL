...
SOURCE_FILES := main.c /main_utils.c lexer/lexer.c lexer/lexer_utils.c lexer/determine_token_type.c lexer/determine_token_type1.c lexer/process1.c lexer/process2.c lexer/process_redirect.c \
				...
				parser/handlers1.c parser/parser_heredoc.c execution/executor_utils2.c /signals/signals.c expansion/expansion.c  \
				parser/initialize_command_structure.c env/arr_to_linked_list.c env/env_utils.c env/linked_list_to_arr.c

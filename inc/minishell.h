...
int process_quotes(char currentChar, char **buffer, int *bufIndex, int *inQuote);
...
int process_double_redirect_out(char **buffer, int *bufIndex, t_token ***tokens, int *TokenCount, t_env *env, int *i);
